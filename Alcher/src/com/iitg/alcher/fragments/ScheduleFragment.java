...
public class ScheduleFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final ImageButton iv_day0 = (ImageButton) rootView.findViewById(R.id.imageButton1);
		final ImageButton iv_day1 = (ImageButton) rootView.findViewById(R.id.imageButton2);
		final ImageButton iv_day2 = (ImageButton) rootView.findViewById(R.id.imageButton3);
		final ImageButton iv_day3 = (ImageButton) rootView.findViewById(R.id.imageButton4);
		...
		iv_day0.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	LoadListView("0");
	        	iv_day0.setBackgroundColor(Color.parseColor("#00000000"));
	        	iv_day1.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day2.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day3.setBackgroundColor(Color.parseColor("#ffffff"));
	        }
		...
		iv_day1.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	LoadListView("1");
	        	iv_day0.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day1.setBackgroundColor(Color.parseColor("#00000000"));
	        	iv_day2.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day3.setBackgroundColor(Color.parseColor("#ffffff"));
	        }
	    });
		...
		iv_day2.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	...
	        	iv_day0.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day1.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day2.setBackgroundColor(Color.parseColor("#00000000"));
	        	iv_day3.setBackgroundColor(Color.parseColor("#ffffff"));
	        }
	    });
		...
		iv_day3.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	...
	        	iv_day1.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day2.setBackgroundColor(Color.parseColor("#ffffff"));
	        	iv_day3.setBackgroundColor(Color.parseColor("#00000000"));
	        }
	    });
